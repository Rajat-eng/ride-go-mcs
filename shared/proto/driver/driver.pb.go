...
func (x *UpdateLocationRequest) GetPackageSlug() string {
	if x != nil {
		return x.PackageSlug
	}
	return ""
...
const file_driver_proto_rawDesc = "" +
	"\n" +
	"\fdriver.proto\x12\x06driver\"i\n" +
	"\x15RegisterDriverRequest\x12\x1a\n" +
	"\bdriverID\x18\x01 \x01(\tR\bdriverID\x12 \n" +
	"\vpackageSlug\x18\x02 \x01(\tR\vpackageSlug\x12\x12\n" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\"\x83\x01\n" +
	"\x15UpdateLocationRequest\x12\x1a\n" +
	"\bdriverID\x18\x01 \x01(\tR\bdriverID\x12,\n" +
	"\blocation\x18\x02 \x01(\v2\x10.driver.LocationR\blocation\x12 \n" +
	"\vpackageSlug\x18\x03 \x01(\tR\vpackageSlug\"\x18\n" +
	"\x16UpdateLocationResponse2\xb3\x01\n" +
	"\rDriverService\x12Q\n" +
	"\x10UnregisterDriver\x12\x1d.driver.RegisterDriverRequest\x1a\x1e.driver.RegisterDriverResponse\x12O\n" +
	"\x0eUpdateLocation\x12\x1d.driver.UpdateLocationRequest\x1a\x1e.driver.UpdateLocationResponseB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_goTypes = []any{
	...
	(*UpdateLocationRequest)(nil),  // 4: driver.UpdateLocationRequest
	(*UpdateLocationResponse)(nil), // 5: driver.UpdateLocationResponse
}
var file_driver_proto_depIdxs = []int32{
	...
	3, // 2: driver.UpdateLocationRequest.location:type_name -> driver.Location
	0, // 3: driver.DriverService.UnregisterDriver:input_type -> driver.RegisterDriverRequest
	4, // 4: driver.DriverService.UpdateLocation:input_type -> driver.UpdateLocationRequest
	1, // 5: driver.DriverService.UnregisterDriver:output_type -> driver.RegisterDriverResponse
	5, // 6: driver.DriverService.UpdateLocation:output_type -> driver.UpdateLocationResponse
